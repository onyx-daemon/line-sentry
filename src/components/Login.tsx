    ...
    <div className={`min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ${
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <div className="mx-auto h-16 w-16 bg-slate-600 rounded-full flex items-center justify-center">
            <Factory className="h-8 w-8 text-white" />
          </div>
          <h2 className={`mt-6 text-3xl font-extrabold ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>
            Dawlance | LineSentry
          </h2>
          <p className={`mt-2 text-sm ${isDarkMode ? 'text-gray-400' : 'text-slate-600'}`}>
        ...
        <div className={`py-8 px-6 shadow-xl rounded-lg border ${
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none`}>
                  <User className={`h-5 w-5 ${isDarkMode ? 'text-gray-400' : 'text-slate-500'}`} />
                </div>
                <input
                  id="username"
                  name="username"
            ...
            <div>
              ...
              <div className="relative">
                <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none`}>
                  <Lock className={`h-5 w-5 ${isDarkMode ? 'text-gray-400' : 'text-slate-500'}`} />
                </div>
                <input
                  id="password"
                  name="password"
